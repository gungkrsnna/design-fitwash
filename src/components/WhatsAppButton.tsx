...
function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed right-6 bottom-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition hover:scale-105 hover:shadow-xl"
    >
      <span className="absolute inset-0 animate-ping rounded-full bg-[#25D366] opacity-75" />
      <svg className="relative h-7 w-7" viewBox="0 0 448 512" fill="currentColor" aria-hidden="true">
